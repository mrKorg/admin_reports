...
class Voga_AdminReports_Block_Adminhtml_Base_Grid_Renderer_Brand extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    const ATTRIBUTE_CODE = 'designer';

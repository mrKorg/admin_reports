<?php
class Voga_AdminReports_Block_Adminhtml_Sales_Newproducts extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $helper = Mage::helper('voga_adminreports');
        $this->_blockGroup = 'voga_adminreports';
        $this->_controller = 'adminhtml_sales_newproducts';
